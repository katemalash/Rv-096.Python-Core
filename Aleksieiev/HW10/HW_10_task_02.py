...
6. Finish the game.''')
    match input('Input your choice: '):
        ...
        case '2':
            ...
            print(f'Pound state = {new_pound.state}. There are {new_pound.fish_count} fishes.')
        case '3':
            ...
            match variable_check(str, 1, 'Input 1 to add Carp fish or 2 to add SheatFish'):
                case '1':
                    new_pound.add_fish(Carp(color='white'))
                    print(f'The wish was added to pound: {Carp(color="white")}')
                case '2':
                    new_pound.add_fish(SheatFish(8, 10))
        ...
        case '5':
            ...
            fish_new = Fish.create_from_data(weight, age, name=name)
